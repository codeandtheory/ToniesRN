...
export default function RecorderScreen() {
  ...
  const renderPlayerControls = () => {
    if (!isPlaying && !isPausedPlayback && !playingUri) return null;
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#F4F1ED]">
      ...
      <Modal
        ...
        transparent
        animationType="slide"
        onRequestClose={() => { stopPlayback(); setShowPlayer(false); }}
      >
        <View className="flex-1 bg-black/50 justify-end">
          <View className="bg-white rounded-t-2xl overflow-hidden">
            ...
            <View className="px-4 pt-3 pb-2 border-b border-gray-200 flex-row items-center justify-between">
              ...
              <TouchableOpacity onPress={() => { stopPlayback(); setShowPlayer(false); }}>
